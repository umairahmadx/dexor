...
class ToolRegistry {
  ...
  static final List<ToolEntry> all = [
    ...
    _tool(
      ...
      'Image',
      '/image/compress',
      ['image', 'compress', 'quality', 'size'],
    ),
    _tool(
      'background-remover',
      'Background Remover',
      'Remove image backgrounds with ML segmentation.',
      Icons.auto_fix_high,
      'Image',
      '/image/bg-remover',
      ['background', 'remove', 'transparent', 'ml'],
    ),
    _tool(
      'image-rotator',
      'Image Rotator',
      ...
      'Image',
      '/image/rotate',
      ['rotate', 'flip', 'angle', 'transform'],
    ),
    _tool(
      'ocr',
      'OCR - Text Recognition',
      'Extract text from images with ML Kit.',
      Icons.text_fields,
      'Image',
      '/image/ocr',
      ['ocr', 'text', 'recognition', 'extract'],
    ),
    _tool(
      'social-resizer',
      'Social Media Resizer',
      'Resize images for Instagram, Facebook, TikTok, and more.',
      Icons.aspect_ratio,
      'Image',
      '/image/social-resizer',
      ['social', 'instagram', 'facebook', 'resize'],
    ),
    _tool(
      'batch-processor',
      'Batch Processor',
      'Process multiple images at once (resize, compress, convert).',
      Icons.apps,
      'Image',
      '/image/batch',
      ['batch', 'multiple', 'bulk', 'process'],
    ),
